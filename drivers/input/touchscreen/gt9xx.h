...
#define GTP_CREATE_WR_NODE    0   //zyh
...
#else   //change by zyh
#define GTP_RST_PORT    S5PV210_GPD0(3)  //change by gaei zyh
#define GTP_INT_PORT    S5PV210_GPH1(6)  //change by gaei zyh
#define GTP_INT_IRQ     gpio_to_irq(GTP_INT_PORT)
#define GTP_INT_CFG     S3C_GPIO_SFN(0xF)
#endif
...
#define GTP_I2C_NAME          "Goodix1-TS"
